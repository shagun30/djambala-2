# -*- coding: utf-8 -*-
"""
/dms/folderschool/views_edit.py

.. enthaelt den View zum Aendern der Eigenschaften des Basisordners fuer Schulen
...
def folderschool_edit(request, item_container):

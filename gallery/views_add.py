# -*- coding: utf-8 -*-
"""
/dms/gallery/views_add.py

.. enthaelt den View zum Ergaenzen einer Galerie
...
from dms.gallery.help_form   import help_form

from dms_ext.extension    import * # dms-Funktionen ueberschreiben

# -----------------------------------------------------
@require_permission('perm_add_folderish')
def gallery_add(request, item_container):
  ...
  def save_values(name, new, my_folder):
    ...
    save_container_values(request.user, 'dmsGallery', name, new, my_folder)
  ...
  app_name = 'gallery'
  my_title = _(u'Galerie anlegen')
  # --- Sind Daten vorhanden oder muessen Sie initialisiert werden?
  show_errors = ( request.method == 'POST' )
  if show_errors:
    data = request.POST.copy()
  else :
    data = { 'name': _(u'galerie'), 'title': _(u'Galerie'), 'sections': _(u'Raum 1'), 'string_2': 10, }
  f = DmsItemForm(data)
  # --- Reihenfolge, Ueberschriften, Hilfetexte
  tabs = [('tab_base',['name', 'title', 'nav_title', 'string_2', 'section', 'sections']),]

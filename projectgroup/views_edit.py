# -*- coding: utf-8 -*-
"""
/dms/projectgroup/views_edit.py

.. enthaelt den View zurm Aendern der Eigenschaften der Arbeitsgruppe
...
0.02  05.11.2007  Aenderungen am Menu
0.03  10.11.2007  save_min_role_id
0.04  25.03.2008  menu_left_id kann korrigiert werden
"""
...
def projectgroup_edit(request, item_container):
  ...
  my_title = _(u'Arbeits- bzw. Lerngruppe ändern')
  data_init = {
  ...
  f = dms_itemForm ( data )
  visibility = ['is_browseable', 'visible_start', 'visible_end', 'string_2']
  if my_role <= 10:   # the_manager
    visibility.append('new_menu')
  tabs = [
          ('tab_base'        , ['title', 'sub_title', 'section', 'sections', 'min_role_id' ]),

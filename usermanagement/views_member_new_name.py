# -*- coding: utf-8 -*-
"""
/dms/usermanagement/views_member_new_name.py
...
0.01  06.12.2007  Beginn der Arbeit
"""
...
def usermanagement_member_new_name(request, item_container):
  """ aendert den Namen eines Community-Mitglieds """
  ...
  my_title = _(u'Namen eines Community-Mitglieds ändern')
  ...
  if request.method == 'POST':
    ...
    vars['next'] = item_container.get_absolute_url() + '?op=member_new_name'

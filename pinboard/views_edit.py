# -*- coding: utf-8 -*-
"""
/dms/pinboard/views_edit.py

.. enthaelt den View zurm Aendern der Eigenschaften der Pinnwand
...
def pinboard_edit(request, item_container):
  """ Eigenschaften der Pinnwand aendern """

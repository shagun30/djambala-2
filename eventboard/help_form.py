# -*- coding: utf-8 -*-
"""
/dms/eventboard/help_form.py

.. enthaelt die kompletten Kontext-Hilfetexte fuer Terminkalender
...
help_form['name'] = {
     ...
     'help'       : _(u"""<p>
Tragen Sie hier den Kurznamen Ihres Terminkalenders ein. Dieser Kurzname wird beim Aufrufen 
des Terminkalenders in der Web-Adresse verwendet.
</p>
...
help_form['title'] = {
     ...
     'help'       : _(u"""<p>
Tragen Sie hier die Überschrift des Terminkalenders ein. Unter dieser Überschrift werden
die Termine angezeigt. Dieser Titel erscheint ebenfalls im übergeordneten Ordner.
</p>
...
help_form['sub_title'] = {
     ...
     'help'       : _(u"""<p>
Falls erforderlich tragen Sie hier die Unterüberschrift Ihres Terminkalenders ein.
...
help_form['is_wide'] = {
     ...
     'help'       : _(u"""<p>
Mit diesem Feld werden die Intro-Informationen in voller Breite angezeigt.
</p>""") }
...
help_form['section'] = {
     ...
     'help'       : _(u"""<p>
Hier legen Sie fest, bei welchem Zwischentitel Ihr Terminkalender im
<b>übergeordneten</b> Ordner angezeigt wird. Bei Bedarf können 
Sie später mit der Aktion "umordnen" Ihren Terminkalender weiter nach oben
oder nach unten verschieben.
</p>""") }

# ----------------------------------------------------------------
help_form['sections'] = {
     'title'      : _(u'Rubriken für diesen Terminkalender'),
     'help'       : _(u"""<p>
Mit diesem Texteingabefeld legen Sie die möglichen Rubriken
dieses Kalenders fest. Rubriken dienen dem Filtern von Ereignissen.
</p>
<p>
...
help_form['visible_end'] = {
     ...
     'help':_(u"""<p>
Dieses Feld legt fest, bis zu welchem Zeitpunkt dieser Kalender sichtbar ist.
</p>""") }
...
help_form['visible_start'] = {
     ...
     'help'       : _(u"""<p>
Dieses Feld legt den Zeitpunkt fest, ab dem dieser Kalender sichtbar ist.
</p>""") }
...
help_form['is_browseable'] = {
     ...
     'help'       : _(u"""<p>
Mit diesem Schalter legen Sie fest, ob dieser Kalender
...
help_form['has_comments'] = {
     ...
     'help'       : _(u"""<p>
Dieser Schalter legt fest, ob Ereignisse dieses Kalenders
...
help_form['is_moderated'] = {
     ...
     'help'       : _(u"""<p>
Dieser Schalter bewirkt, dass Beiträge entweder sofort sichtbar werden
...
help_form['owner'] = {
     ...
     'help'       : _(u"""<p>
Tragen Sie bitte die Person oder die Institution ein, die für diesen
Kalender zuständig bzw. verantwortlich ist.
</p>""") }
...
help_form['owner_email'] = {
     ...
     'help'       : _(u"""<p>
Jedes neu eingestellte Ereignis erzeugt automatisch eine Kontroll-E-Mail.
...
help_form['integer_2'] = {
     'title'      : _(u'Anzeige'),
     'help'       : _(u"""<p>
Dieser Schalter bewirkt, dass die Termine entweder als Monatskalender (Voreinstellung) oder als Liste angezeigt werden.
</p>""") }

# ----------------------------------------------------------------
help_form['integer_3'] = {
     'title'      : _(u'Sortierreihenfolge'),
     'help'       : _(u"""<p>
Dieser Schalter bewirkt, dass mehrtägige Termine nach dem Anfangsdatum (Voreinstellung) oder
nach dem Ende-Datum gelistet werden.
</p>""") }

# ----------------------------------------------------------------
help_form['integer_4'] = {
     'title'      : _(u'Geschützte Neueinträge'),
     'help'       : _(u"""<p>
Mit diesem Schalter legen Sie fest, ob ausschließlich Community-Mitglieder
oder auch anonyme Besucherinnen und Besucher neue Einträge vornehmen dürfen.
</p>""") }
...
help_form['tab_user_support'] = {
     ...
     'info'       : _(u"""<p>
Hier legen Sie fest, ob bzw. wer von außen Ereignisse einstellen darf.
</p>""") }

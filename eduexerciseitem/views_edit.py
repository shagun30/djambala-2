# -*- coding: utf-8 -*-
"""
/dms/eduexerciseitem/views_edit.py
...
def eduexerciseitem_edit(request, item_container):
  ...
  def save_values(item_container, old, new):
    ...
    old['integer_6'] = item_container.item.integer_6
    new['integer_6'] = new['max_points']
    old['string_2'] = item_container.item.string_2
  ...
  data_init = {
                ...
                'points'            : item_container.item.string_2,
  ...
  f = dms_itemForm ( data )
  if item_container.is_data_object:
    tabs = [ ('tab_base',        [ 'title', 'nav_title', 'text', 'max_points', 'points', 'schlagwort', ]),
    ...
    my_title = _(u'Einblendung einer Aufgabe ändern')

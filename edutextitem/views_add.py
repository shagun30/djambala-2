# -*- coding: utf-8 -*-
"""
/dms/edutextitem/views_add.py

.. enthaelt den View zum Ergaenzen eines Textes in den Lernarchiven
...
# -----------------------------------------------------
@login_required
def edutextitem_add(request, item_container):
  """ neues Ttextdokument fuer Lernarchiv anlegen """
  ...
  def save_values(name, new, item_container):
    ...
    item_container_new = save_item_values(request.user, 'dmsEduTextItem', name, new,
                                          item_container,
  ...
  class DmsItemForm(forms.Form):
    ...
    titel_lang = forms.CharField(required=False, max_length=240,
         widget=forms.TextInput(attrs={'size':60}) )
    beschreibung_lang = forms.CharField(
  ...
  my_title = _(u'Textdokument im Lernarchiv anlegen')
  ...
  if show_errors:
    ...
    data = { 'license': 1, 
             ...
             'rechte': _(u'Diese Ressource kann für unterrichtliche Zwecke genutzt werden.'),
             'is_browseable': True,

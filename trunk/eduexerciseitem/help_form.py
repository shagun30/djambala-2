# -*- coding: utf-8 -*-
"""
/dms/eduexerciseitem/help_form.py

.. enthaelt die kompletten Kontext-Hilfetexte fuer Aufgaben in Lernarchiven
...
help_form['name'] = {
     ...
     'help'       : _(u"""<p>
Tragen Sie hier den Kurznamen Ihrer Aufgabe ein. Dieser Kurzname wird beim Aufrufen 
...
help_form['sub_title'] = {
     ...
     'help'       : _(u"""<p>
Falls erforderlich tragen Sie hier die Unterüberschrift Ihrer Aufgabe ein.
...
help_form['text'] = {
     'title'      : _(u'Aufgabe'),
     'help'       : _(u"""<p>
Mit diesem Eingabefeld beschreiben Sie Ihre Aufgabe. Sie können dieses Feld
leer lassen, wenn Sie die eigentliche Aufgabe als Datei einstellen.
</p>""") }

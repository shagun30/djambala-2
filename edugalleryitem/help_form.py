# -*- coding: utf-8 -*-
"""
/dms/edugalleryitem/help_form.py

.. enthaelt die kompletten Kontext-Hilfetexte fuer Galerien in Lernarchiven
...
Ihre Galerie angezeigt. Dieser Titel erscheint ebenfalls im übergeordneten
Lernarchiv.
</p>
...
help_form['text'] = {
     ...
     'help'       : _(u"""<p>
Mit diesem Eingabefeld beschreiben Sie Ihre Galerie.
</p>""") }
...
# ----------------------------------------------------------------
help_form['sections'] = {
     'title'      : _(u'Räume der Galerie'),
     'help'       : _(u"""<p>
Mit diesem Texteingabefeld beschreiben Sie die Ausstellungsräume Ihrer Galerie.
</p>""") }
...
help_form['tab_image'] = {
     'title'      : _(u'Bild'),
     'info'       : _(u"""<p>
Sie können Ihre Galerie mit einem kleinen Bild versehen.
</p>""") }
...
help_form['tab_visibility'] = {
     ...
     'info'       : _(u"""<p>
Sie können die Sichtbarkeit der Galerie auf unterschiedliche Weisen steuern.
</p>""") }

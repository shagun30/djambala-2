# -*- coding: utf-8 -*-
"""
/dms/discusscoard/views_add.py

.. enthaelt den View zum Ergaenzen eines Diskussionsforums
...
def discussboard_add(request, item_container):
  ...
  def save_values(name, new, my_folder):
    ...
    save_container_values(request.user, 'dmsDiscussboard', name, new, my_folder)
  ...
  my_title = _(u'Diskussionsforum anlegen')
  # --- Sind Daten vorhanden oder muessen Sie initialiSiert werden?
  show_errors = ( request.method == 'POST' )
  if show_errors:
    data = request.POST.copy()
  else :
    data = { 'name': _(u'forum'), 'title': _(u'Diskussionsforum') }
  f = DmsItemForm(data)

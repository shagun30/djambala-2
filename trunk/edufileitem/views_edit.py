# -*- coding: utf-8 -*-
"""
/dms/edufileitem/views_edit.py

.. enthaelt den View zum Aendern der Eigenschaften einer Datei innerhalb der Lernarchive
...
0.04  30.10.2007  Materialtyp laesst sich aendern
"""
...
def edufileitem_edit(request, item_container):
  ...
  app_name = u'edufileitem'
  my_title = _(u'Datei innerhalb der Lernarchive ändern')
  ...
  if request.method == 'POST' and not f.errors :
    ...
    return render_to_response('app/edufileitem/manage_edit.html', vars)

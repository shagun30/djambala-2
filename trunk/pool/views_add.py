# -*- coding: utf-8 -*-
"""
/dms/pool/views_add.py

.. enthaelt den View zum Ergaenzen eines Materialpools
...
from dms.pool.help_form   import help_form

from dms_ext.extension    import * # dms-Funktionen ueberschreiben

# -----------------------------------------------------
@require_permission('perm_add_folderish')
def pool_add(request, item_container):
  """ neuen Materialpool anlegen """

  def save_values(name, new, my_folder):
    """ Daten sichern """
    save_container_values(request.user, 'dmsPool', name, new, my_folder)
  ...
  app_name = 'pool'
  my_title = _(u'Materialpool anlegen')
  # --- Sind Daten vorhanden oder muessen Sie initialiSiert werden?
  show_errors = ( request.method == 'POST' )
  if request.method == 'POST':
    data=request.POST.copy()
  else :
    data = { 'name': _(u'material'),
             'title': _(u'Materialpool'),
           }

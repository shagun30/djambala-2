#-*-coding: utf-8 -*-
"""
/dms/hessen/schooldb/views_edit.py
...
0.01  16.01.2008  Beginn der Arbeit
0.02  07.03.2008  Straffung des Programmcodes
0.03  10.03.2008  string_1
"""
...
def schooldb_edit(request, item_container):
  """ Eigenschaften der Seite zum Anzeigen der Schul-Datenbank aendern """
  ...
  app_name = u'schooldb'
  my_title = _(u'Suchformular für Schul-Datenbank ändern')
  ...
  tabs = [
          ...
          ( u'tab_visibility', [ u'string_1', u'is_browseable', u'visible_start', u'visible_end', ] ),
        ]

# -*- coding: utf-8 -*-
"""
/dms/linklist/help_form.py

.. enthaelt die kompletten Kontext-Hilfetexte fuer Linklisten
...
help_form['name'] = {
     ...
     'help'       : _(u"""<p>
Tragen Sie hier den Kurznamen Ihrer Linkliste ein. Dieser Kurzname wird beim Aufrufen 
der Linkliste in der Web-Adresse verwendet.
</p>
...
help_form['title'] = {
     ...
     'help'       : _(u"""<p>
Tragen Sie hier die Überschrift der Linkliste ein. Unter dieser Überschrift wird 
die Linkliste angezeigt. Dieser Titel erscheint ebenfalls im übergeordneten
Ordner.
</p>
...
help_form['sub_title'] = {
     ...
     'help'       : _(u"""<p>
Falls erforderlich tragen Sie hier die Unterüberschrift Ihrer Linkliste ein.
...
help_form['section'] = {
     ...
     'help'       : _(u"""<p>
Hier legen Sie fest, bei welchem Zwischentitel Ihre Linkliste im
<b>übergeordneten</b> Ordner angezeigt wird. Bei Bedarf können 
Sie später mit der Aktion "umordnen" Ihre Linkliste weiter nach oben
oder nach unten verschieben.
</p>""") }

# ----------------------------------------------------------------
help_form['sections'] = {
     'title'      : _(u'Rubriken für diese Linkliste'),
     'help'       : _(u"""<p>
Mit diesem Texteingabefeld legen Sie die möglichen Rubriken
diese Linkliste fest. Rubriken dienen dem Filtern von Verweisen.
</p>
<p>
...
help_form['has_comments'] = {
     ...
     'help'       : _(u"""<p>
Dieser Schalter legt fest, ob Verweise dieser Linkliste
...
Linkliste zuständig bzw. verantwortlich ist.
</p>""") }

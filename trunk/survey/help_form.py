...
help_form['name'] = {
     ...
     'help'       : _(u"""<p>
Tragen Sie hier den Kurznamen Ihres Fragebogens ein. Dieser Kurzname wird beim Aufrufen 
...
help_form['title'] = {
     ...
     'help'       : _(u"""<p>
Tragen Sie hier die Überschrift des Fragebogens ein. Unter dieser Überschrift wird 
der Fragebogen angezeigt. Dieser Titel erscheint ebenfalls im übergeordneten
Ordner.
</p>
...
help_form['sub_title'] = {
     ...
     'help'       : _(u"""<p>
Falls erforderlich tragen Sie hier die Unterüberschrift Ihres Fragebogens ein.
...
des Überschrift im Sinne einer Einführung angezeigt wird. Tragen Sie
beispielsweise wichtige Hinweise zum Ausfüllen des Fragebogens ein.
</p>
...
help_form['string_1'] = {
     'title'      : _(u'Speichern'),
     'help'       : _(u"""<p>
Tragen Sie hier die Beschriftung der Schaltfläche ein, die zum Speichern des Fragebogens
...
help_form['section'] = {
     ...
     'help'       : _(u"""<p>
Hier legen Sie fest, bei welchem Zwischentitel Ihr Fragebogen im
<b>übergeordneten</b> Ordner angezeigt wird. Bei Bedarf können 
Sie später mit der Aktion "umordnen" Ihren Fragebogen weiter nach oben
...
help_form['sections'] = {
     'title'      : _(u'Reiter'),
     'help'       : _(u"""<p>
Längere Fragebogen können mit "Reiter" in inhaltlich zusammenhängende Teilbereiche
aufgeteilt werden. - Sie müssen mindestens einen Reiter angeben!
</p>""") }
...
help_form['visible_end'] = {
     ...
     'help':_(u"""<p>
Dieses Feld legt fest, bis zu welchem Zeitpunkt dieser Fragebogen sichtbar ist.
</p>""") }
...
help_form['visible_start'] = {
     ...
     'help'       : _(u"""<p>
Dieses Feld legt den Zeitpunkt fest, ab dem dieser Fragebogen sichtbar ist.
</p>""") }
...
help_form['is_browseable'] = {
     ...
     'help'       : _(u"""<p>
Mit diesem Schalter legen Sie fest, ob dieser Fragebogen
...
help_form['integer_1'] = {
     'title'      : _(u'Typ'),
     'help'       : _(u"""<p>
Bitte legen Sie fest, ob dieses Objekt als <i>anonymer Fragebogen</i> oder im Sinne
eines <i>Erfassungsformular</i> verwenden werden soll.
</p>
<p>
<b>Der Typ kann nachträglich nicht geändert werden!</b>
</p>""") }
...
help_form['integer_2'] = {
     'title'      : _(u'Eingaben'),
     'help'       : _(u"""<p>
Mit dieser Schaltfläche legen Sie fest, ob Eingaben in den Fragebogen möglich
sind oder nicht.
</p>""") }

# ----------------------------------------------------------------
help_form['integer_3'] = {
     'title'      : _(u'Eingaben löschen'),
     'help'       : _(u"""<p>
Sollen alle bisherigen Eingaben wirklich gelöscht werden?
</p>""") }
...
help_form['tab_reset'] = {
     'title'      : _(u'Daten löschen'),
     'info'       : _(u"""<p>
Bitte bedenken Sie, dass gelöschte Daten nicht mehr restauriert werden können.
</p>""") }

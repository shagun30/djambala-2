# -*- coding: utf-8 -*-
"""
/dms/newsletteritem/views_edit.py

.. enthaelt den View zum Aendern der Eigenschaften eines Beitrags zum Newsletter
...
def newsletteritem_edit(request, item_container):
  """ Eigenschaften des Beitrags zum Newsletter aendern """
  ...
  my_title = _(u'Beitrag zum Newsletter ändern')

...
<p>
Der Dateiname Ihrer Datei ist zugleich der Kurzname auf dem Server. Falls also bereits
...
help_form['title'] = {
     ...
     'help'       : _(u"""<p>
Tragen Sie hier die Überschrift Ihrer Datei ein. Mit dieser Überschrift wird
Ihre Datei in der Übersicht des Ordners angezeigt.
</p>
...
help_form['text'] = {
     'title'      : _(u'Text'),
     'help'       : _(u"""<p>
Geben Sie hier bitte die Beschreibung Ihrer Datei ein.

# -*- coding: utf-8 -*-
"""
/dms/guestbookitem/views_edit.py

.. enthaelt den View zum Aendern der Eigenschaften eines Gaestebucheintrags
...
def guestbookitem_edit(request, item_container):
  ...
  my_title = _(u'Gästebuchbeitrag ändern')

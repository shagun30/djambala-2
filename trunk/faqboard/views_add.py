# -*- coding: utf-8 -*-
"""
/dms/faqboard/views_add.py

.. enthaelt den View zum Ergaenzen einer FAQ-Liste
...
from dms.faqboard.help_form   import help_form

from dms_ext.extension    import * # dms-Funktionen ueberschreiben

# -----------------------------------------------------
@require_permission('perm_add_folderish')
def faqboard_add(request, item_container):
  """ neue FAQ-Liste anlegen """
  ...
  def save_values(name, new, my_folder):
    ...
    save_container_values(request.user, 'dmsFAQboard', name, new, my_folder)
  ...
  app_name = 'faqboard'
  my_title = _(u'FAQ-Liste anlegen')
  # --- Sind Daten vorhanden oder muessen sie initialisiert werden?
  show_errors = ( request.method == 'POST' )
  if show_errors:
    data = request.POST.copy()
  else :
    #data = { 'name': _(u'faq'), 'title': _(u'FAQ-Liste') }
    data = { 'name': _(u'faq'), 'title': _(u'FAQ-Liste'), 'sections': decode_html(item_container.container.sections) }
  f = DmsItemForm(data)

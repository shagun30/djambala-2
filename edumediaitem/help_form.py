# -*- coding: utf-8 -*-
"""
/dms/edumediaitem/help_form.py

.. enthaelt die kompletten Kontext-Hilfetexte fuer Medienpakete in Lernarchiven
...
help_form['name'] = {
     ...
     'help'       : _(u"""<p>
Tragen Sie hier den Kurznamen Ihres Medienpakets ein. Dieser Kurzname wird beim Aufrufen 
...
help_form['title'] = {
     ...
     'help'       : _(u"""<p>
Tragen Sie hier die Überschrift des Medienpaket ein. Unter dieser Überschrift wird 
das Medienpaket angezeigt. Dieser Titel erscheint ebenfalls im übergeordneten
Lernarchiv.
</p>
...
help_form['sub_title'] = {
     ...
     'help'       : _(u"""<p>
Falls erforderlich tragen Sie hier die Unterüberschrift Ihres Medienpakets ein.
...
help_form['text'] = {
     ...
     'help'       : _(u"""<p>
Mit diesem Eingabefeld beschreiben Sie Ihr Medienpaket.
</p>""") }
...
# ----------------------------------------------------------------
help_form['sections'] = {
     'title'      : _(u'Zwischentitel für dieses Medienpaket'),
     'help'       : _(u"""<p>
Mit diesem Texteingabefeld legen Sie die möglichen Zwischentitel 
für dieses Medienpaket fest.
</p>
<p>
...
help_form['tab_image'] = {
     'title'      : _(u'Bild'),
     'info'       : _(u"""<p>
Sie können Ihr Medienpaket mit einem kleinen Bild versehen.
</p>""") }
...
help_form['tab_visibility'] = {
     ...
     'info'       : _(u"""<p>
Sie können die Sichtbarkeit des Medienpakets auf unterschiedliche Weisen steuern.
</p>""") }

# -*- coding: utf-8 -*-
"""
/dms/exercisefolder/help_form.py

.. enthaelt die kompletten Kontext-Hilfetexte fuer eine Aufgabensammlung
...
help_form['name'] = {
     ...
     'help'       : _(u"""<p>
Tragen Sie hier den Kurznamen Ihrer Aufgabensammlung ein. Dieser Kurzname wird beim Aufrufen 
in der Web-Adresse verwendet. Der Kurzname sollte den Inhalt Ihrer
Aufgaben möglichst präzise beschreiben und gleichzeitig möglichst kurz
sein.
</p>
...
help_form['title'] = {
     ...
     'help'       : _(u"""<p>
Tragen Sie hier die Überschrift der Aufgabensammlung ein. Unter dieser Überschrift werden
die Aufgaben angezeigt.
</p>
...
help_form['sub_title'] = {
     ...
     'help'       : _(u"""<p>
Falls erforderlich tragen Sie hier die Unterüberschrift Ihre Aufgabensammlung ein.
...
des Überschrift im Sinne einer Einführung angezeigt wird.
</p>
...
help_form['section'] = {
     ...
     'help'       : _(u"""<p>
Hier legen Sie fest, bei welchem Zwischentitel Ihre Aufgabensammlung im
...
help_form['is_moderated'] = {
     ...
     'help'       : _(u"""<p>
Dieser bewirkt, dass Aufgaben entweder sofort sichtbar werden
...
help_form['integer_1'] = {
     'title'      : _(u'Template'),
     'help'       : _(u"""<p>
Hier können Sie, falls vorhanden, unterschiedliche Templates für Ihre Aufgabensammlung auswählen.
</p>""") }
...
help_form['integer_2'] = {
     'title'      : _(u'Stufe'),
     'help'       : _(u"""<p>
Bitte wählen Sie die passende Stufe aus.
</p>""") }
...
help_form['tab_visibility'] = {
     ...
     'info'       : _(u"""<p>
Sie können die Sichtbarkeit der Aufgabensammlung auf unterschiedliche Weisen steuern.
</p>""") }

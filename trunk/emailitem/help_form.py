...
title, email, organisation, sub_organisation, street, zip, town, homepage</tt>
</p>""") }
...
help_form['sub_title'] = {
     ...
     'help'       : _(u"""<p>
Falls erforderlich, können Sie hier zu Ihrer Frage eine kurze Erläuterung eintragen.
</p>""") }

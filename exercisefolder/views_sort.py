# -*- coding: utf-8 -*-
"""
/dms/exercisefolder/views_sort.py
...
# -----------------------------------------------------
@require_permission('perm_manage_folderish')
def exercisefolder_sort(request, item_container):
  """ Objekte der Aufgabensammlung umsortieren """

  return do_sort(request, item_container, 'exercisefolder', _(u'Aufgaben(sammlungen) umordnen'),
                 ['dmsExerciseFolder'])

# -*- coding: utf-8 -*-
"""
/dms/projectgroupemail/views_edit.py

.. enthaelt den View zum Aendern der Eigenschaften des Rundschreibens
...
def projectgroupemail_edit(request, item_container):
  ...
  my_title = _(u'Rundschreiben ändern')
  data_init = {

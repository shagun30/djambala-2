# -*- coding: utf-8 -*-
"""
/dms/newsboard/views_add.py

.. enthaelt den View zum Ergaenzen eines Nachrichtenbretts
...
0.03  31.01.2007  Straffung, teilweise Auslagerung nach models
0.04  09.05.2007  get_folderish_vars
"""
...
from dms.newsboard.help_form   import help_form

from dms_ext.extension    import * # dms-Funktionen ueberschreiben

# -----------------------------------------------------
@require_permission('perm_add_folderish')
def newsboard_add(request, item_container):
  """ neues Nachrichtenbrett anlegen """

  def save_values(name, new, my_folder):
    """ Daten sichern """
    new['has_user_support'] = True
    new['is_moderated'] = True
    new['integer_1'] = 30 # valid_days
    new['integer_2'] = 0
    item_container = save_container_values(request.user, 'dmsNewsboard', name, new, my_folder)
  ...
  app_name = 'newsboard'
  my_title = _(u'Nachrichtenbrett anlegen')

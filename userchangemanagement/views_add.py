# -*- coding: utf-8 -*-
"""
/dms/userchangemanagement/views_add.py

.. enthaelt den View zur Verwaltung der User
...
def userchangemanagement_add(request, item_container):
  """ Objekt zur User-Verwaltung anlegen """

  def save_values(name, new, item_container):
    """ legt das User-Data-Objekt an """
    save_item_values(request.user, 'dmsUserChangeManagement', name,
  ...
  my_title = _(u'Objekt zum Ändern der eigenen Daten anlegen')
  ...
  if show_errors:
    ...
    data = {'name': 'user_data_edit',
            'title': decode_html(_(u'Daten zur eigenen Person ändern'))}

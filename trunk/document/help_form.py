...
help_form['text'] = {
     'title'      : _(u'Text'),
     'help'       : _(u"""<p>
Geben Sie hier bitte den eigentlichen Text Ihrer Informationsseite ein.
...
help_form['rss_feeds'] = {
     'title'      : _(u'RSS-Feeds'),
     'help'       : _(u"""<p>
Tragen Sie hier bitte den bzw. die RSS-Feeds ein, in die Ihr Beitrag aufgenommen
werden soll.
</p>""") }

# -*- coding: utf-8 -*-
"""
/dms/guestbookitem/views_add.py

.. enthaelt den View zum Ergaenzen eines Gaestebucheintrags
...
from dms.guestbookitem.help_form  import help_form

from dms_ext.extension    import * # dms-Funktionen ueberschreiben

# -----------------------------------------------------.
def guestbookitem_add(request, item_container):
  ...
  def save_values(name, new, my_folder):
    """ Daten sichern """
    new['section'] = ''
    save_item_values(request.user, 'dmsGuestbookItem', name, new, my_folder,
  ...
  my_title = _(u'Gästebucheintrag anlegen')
  ...
  if request.method == 'POST' and not f.errors:
    ...
    if is_ok:
      ...
      name = 'gb_item_' + now[:string.find(now, '.')] + '.html'

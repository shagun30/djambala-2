# -*- coding: utf-8 -*-
"""
/dms/newsletteritem/help_form.py

.. enthaelt die kompletten Kontext-Hilfetexte fuer Beitraege zu einem Newsletter
...
help_form['title'] = {
     'title'      : _(u'Betreff'), 
     'help'       : _(u"""<p>
Tragen Sie hier den Betreff Ihres Beitrags zum Newsletter ein.
</p>
...
help_form['moderated_text'] = {
      'title': _(u'Moderierter Newsletter'),
      'info' : _(u"""<p>
<b>Dieser Newsletter ist moderiert. Ihr neuer Beitrag wird erst
...
help_form['section'] = {
     ...
     'help'       : _(u"""<p>
Hier legen Sie fest, bei welchem Zwischentitel Ihr Beitrag im Newsletter angezeigt wird.
</p>""") }

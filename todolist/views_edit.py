# -*- coding: utf-8 -*-
"""
/dms/todolist/views_edit.py

.. enthaelt den View zurm Aendern der Eigenschaften der To-Do-Liste
...
def todolist_edit(request, item_container):
  """ Eigenschaften der To-Do-Liste aendern """
  ...
  app_name = 'todolist'
  my_title = _(u'To-Do-Liste ändern')
  data_init = {

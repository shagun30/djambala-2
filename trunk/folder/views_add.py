...
def folder_add(request, item_container):
  ...
  def save_values(name, new, item_container):
    ...
    # --- Org-ID zurücksetzen
    new['integer_1'] = 0
    save_container_values(request.user, 'dmsFolder', name, new, item_container)

# -*- coding: utf-8 -*-
"""
/dms/newsletter/help_form.py

.. enthaelt die kompletten Kontext-Hilfetexte fuer Newsletter
...
help_form['name'] = {
     ...
     'help'       : _(u"""<p>
Tragen Sie hier den Kurznamen Ihres Newsletters ein. Dieser Kurzname wird beim Aufrufen 
des Newsletters in der Web-Adresse verwendet.
</p>
...
help_form['title'] = {
     ...
     'help'       : _(u"""<p>
Tragen Sie hier die Überschrift des Newsletters ein. Unter dieser Überschrift wird 
der Newsletter angezeigt. Dieser Titel erscheint ebenfalls im übergeordneten
Ordner.
</p>
...
help_form['sub_title'] = {
     ...
     'help'       : _(u"""<p>
Falls erforderlich tragen Sie hier die Unterüberschrift Ihres Newsletters ein.
...
# ----------------------------------------------------------------
help_form['sections'] = {
     'title'      : _(u'Ausgaben dieses Newsletters'),
     'help'       : _(u"""<p>
Mit diesem Texteingabefeld legen Sie die Namen der möglichen Ausgaben 
dieses Newsletters fest.
</p>
<p>
Wichtig: Jeder Ausgaben-Name muss in einer eigenen Zeile stehen. Sie
...
help_form['visible_end'] = {
     ...
     'help':_(u"""<p>
Dieses Feld legt fest, bis zu welchem Zeitpunkt dieser Newsletter sichtbar ist.
</p>""") }
...
help_form['visible_start'] = {
     ...
     'help'       : _(u"""<p>
Dieses Feld legt den Zeitpunkt fest, ab dem dieser Newsletter sichtbar ist.
</p>""") }
...
help_form['is_browseable'] = {
     ...
     'help'       : _(u"""<p>
Mit diesem Schalter legen Sie fest, ob <i>dieser</i> Newsletter
...
help_form['has_comments'] = {
     ...
     'help'       : _(u"""<p>
Dieser Schalter legt fest, ob Beiträge zum Newsletter kommentiert werden
...
nächsten Userfolder als die Empfänger des Newsletters eingetragen.

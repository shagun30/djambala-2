# -*- coding: utf-8 -*-
"""
/dms/newsletter/views_edit.py

.. enthaelt den View zum Aendern der Eigenschaften des Newsletters
...
def newsletter_edit(request, item_container):
  """ Eigenschaften des Newsletters aendern """
  ...
  app_name = 'newsletter'
  my_title = _(u'Newsletter ändern')
  data_init = {

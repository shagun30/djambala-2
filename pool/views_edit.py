# -*- coding: utf-8 -*-
"""
/dms/pool/views_edit.py

.. enthaelt den View zurm Aendern der Eigenschaften des Materialpools
...
def pool_edit(request, item_container):
  """ Eigenschaften des Materialpools aendern """
  ...
  app_name = 'pool'
  my_title = _(u'Materialpool ändern')
  data_init = {

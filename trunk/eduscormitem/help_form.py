# -*- coding: utf-8 -*-
"""
/dms/eduscormitem/help_form.py

.. enthaelt die kompletten Kontext-Hilfetexte fuer Scorm-Archive/Content-Packages in Lernarchiven
...
# ----------------------------------------------------------------
help_form['fname'] = {
     'title'      : _(u'Scorm/Content Package'),
     'help'       : _(u"""<p>
Wählen Sie bitte auf Ihrer Festplatte das Scorm-Archiv bzw. Ihr Content-Package aus, das
Sie auf den Server übertragen möchten. Beachten Sie bitte, dass nur Scorm 1.2 Pakete
unterstützt werden.
</p>
...
help_form['title'] = {
     ...
     'help'       : _(u"""<p>
Tragen Sie hier die Überschrift Ihres Scorm-Archivs bzw. Ihres Content-Package ein.
Dieser Titel erscheint in der Übersicht des Lernarchivs.
</p>
...
Er sollte deshalb die Inhalte Ihres Scorm-Archivs bzw. Content-Package knapp und präzise beschreiben.
</p>
<p>
...
help_form['tab_update'] = {
     'title'      : _(u'Upload'),
     'info'       : _(u"""<p>
Hier können Sie das auf dem Server vorhandene Scorm-Archiv bzw. Content-Package ersetzen.<br />

# -*- coding: utf-8 -*-
"""
/dms/linklist/views_add.py

.. enthaelt den View zum Ergaenzen einer Linkliste
...
def linklist_add(request, item_container):
  ...
  def save_values(name, new, my_folder):
    ...
    new['integer_1'] = 30
    new['integer_2'] = 0
    item_container = save_container_values(request.user, 'dmsLinklist', name, new, my_folder)

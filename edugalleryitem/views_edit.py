# -*- coding: utf-8 -*-
"""
/dms/edugalleryitem/views_edit.py

.. enthaelt den View zum Aendern der Eigenschaften des Edu-Galerien
...
def edugalleryitem_edit(request, item_container):
  ...
  data_init = {
                ...
                'string_2'          : int(item_container.item.string_2),
  ...
  f = dms_itemForm ( data )
  if item_container.is_data_object:
    tabs = [ ('tab_base',        [ 'lernrestyp', 'title', 'nav_title', 'text', 'sections', 'string_2', 'schlagwort', ]),

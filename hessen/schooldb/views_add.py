# -*- coding: utf-8 -*-
"""
/dms/hessen/schooldb/views_add.py

.. enthaelt den View zum Ergaenzen der Anzeige der Schul-Datenbank
...
def schooldb_add(request, item_container):
  ...
  def save_values(name, new, my_folder):
    """ Daten sichern """
    save_item_values(request.user, 'dmsSchoolDB', name, new, my_folder, True, False)
  ...
  app_name = u'schooldb'
  my_title = _(u'Suchformular für Schul-Datenbank anlegen')
  # --- Sind Daten vorhanden oder muessen Sie initialiSiert werden?
  show_errors = ( request.method == 'POST' )
  if show_errors:
    data = request.POST.copy()
  else :
    data = {'name': 'suche_schul_db.html',
            'title': 'Suchformular für hessische Schul-Datenbank'}

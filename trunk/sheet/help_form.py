...
.. enthaelt die kompletten Kontext-Hilfetexte fuer Folien 
...
help_form['name'] = {
     ...
     'help'       : _(u"""<p>
Tragen Sie hier den Kurznamen Ihrer Folie ein. Dieser Kurzname wird beim Aufrufen
der verwendet. Der Kurzname sollte den Inhalt
...
help_form['title'] = {
     ...
     'help'       : _(u"""<p>
Tragen Sie hier die Überschrift Ihrer Folie ein. Unter dieser Überschrift wird 
...
help_form['text'] = {
     'title'      : _(u'Text'),
     'help'       : _(u"""<p>
Geben Sie hier bitte den eigentlichen Text ein.
...
help_form['section'] = {
     ...
     'help'       : _(u"""<p>
Hier legen Sie fest, beim welchem Zwischentitel Ihre Folie im
...
help_form['tab_image'] = {
     'title'      : _(u'Bild'),
     'info'       : _(u"""<p>
Sie können Ihre Folie mit einem kleinen Bild schmücken.
</p>""") }

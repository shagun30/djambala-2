# -*- coding: utf-8 -*-
"""
/dms/edulinkitem/views_edit.py

.. enthaelt den View zum Aendern der Eigenschaften eines Verweises innerhalb der Lernarchive
...
def edulinkitem_edit(request, item_container):
  ...
  app_name = u'edulinkitem'
  my_title = _(u'Verweis innerhalb der Lernarchive ändern')
  ...
  if item_container.is_data_object:
    if item_container.container.sections.strip() != '':
      base = ('tab_base', [ 'lernrestyp', 'title', 'url_more', 'text',
                            'section', 'schlagwort', ])
    else:
    ...
    my_title = _(u'Einblendung eines Verweises im Lernarchiv ändern')

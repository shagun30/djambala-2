# -*- coding: utf-8 -*-
"""
/dms/guestbook/views_add.py

.. enthaelt den View zum Ergaenzen eines Ordners
...
from dms.guestbook.help_form   import help_form

from dms_ext.extension    import * # dms-Funktionen ueberschreiben

# -----------------------------------------------------
@require_permission('perm_add_folderish')
def guestbook_add(request, item_container):
  """ neues Gaestebuch anlegen """
  ...
  def save_values(name, new, my_folder):
    ...
    save_container_values(request.user, 'dmsGuestbook', name, new, my_folder)
  ...
  app_name = 'guestbook'
  my_title = _(u'Gästebuch anlegen')
  # --- Sind Daten vorhanden oder muessen Sie initialiSiert werden?
  show_errors = ( request.method == 'POST' )
  if show_errors:
    data = request.POST.copy()
  else :
    data = { 'name': _(u'gaestebuch'), 'title': _(u'Gästebuch') }
  f = DmsItemForm(data)

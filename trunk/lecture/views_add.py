# -*- coding: utf-8 -*-
"""
/dms/lecture/views_add.py

.. enthaelt den View zum Ergaenzen eines Vortrags
...
def lecture_add(request, item_container):
  ...
  def save_values(name, new, my_folder):
    ...
    new['nav_title'] = ''
    new['show_next'] = True
    save_container_values(request.user, 'dmsLecture', name, new, my_folder)
  ...
  app_name = 'lecture'
  my_title = _(u'Vortrag anlegen')
  # --- Sind Daten vorhanden oder muessen Sie initialiSiert werden?
  show_errors = ( request.method == 'POST' )
  if show_errors:
    data = request.POST.copy()
  else :
    data = { 'name': _(u'vortrag'), 
             'title': _(u'Vortrag'), 
             'sections': _(u'Problemlage\nLösungswege\nAusblick\n'), }
  f = DmsItemForm(data)
  # --- Reihenfolge, Ueberschriften, Hilfetexte
  tabs = [('tab_base',['name', 'title', 'sub_title', 'section', 'sections', ]),]

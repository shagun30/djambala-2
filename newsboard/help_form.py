# -*- coding: utf-8 -*-
"""
/dms/newsboard/help_form.py

.. enthaelt die kompletten Kontext-Hilfetexte fuer Nachrichtenbretter
...
help_form['name'] = {
     ...
     'help'       : _(u"""<p>
Tragen Sie hier den Kurznamen Ihres Nachrichtenbretts ein. Dieser Kurzname wird beim Aufrufen 
des Nachrichtenbretts in der Web-Adresse verwendet.
</p>
...
help_form['title'] = {
     ...
     'help'       : _(u"""<p>
Tragen Sie hier die Überschrift des Nachrichtenbretts ein. Unter dieser Überschrift wird 
das Nachrichtenbrett angezeigt. Dieser Titel erscheint ebenfalls im übergeordneten
Ordner.
</p>
...
help_form['sub_title'] = {
     ...
     'help'       : _(u"""<p>
Falls erforderlich tragen Sie hier die Unterüberschrift Ihres Nachrichtenbretts ein.
...
help_form['text'] = {
     'title'      : _(u'Intro'),
     'help'       : _(u"""<p>
Mit diesem Eingabefeld legen Sie den Text fest, der unterhalb der
Überschrift im Sinne einer Einführung angezeigt wird. Sie sollten dieses
...
help_form['section'] = {
     ...
     'help'       : _(u"""<p>
Hier legen Sie fest, bei welchem Zwischentitel Ihr Nachrichtenbrett im
<b>übergeordneten</b> Ordner angezeigt wird. Bei Bedarf können 
Sie später mit der Aktion "umordnen" Ihr Nachrichtenbrett weiter nach oben
oder nach unten verschieben.
</p>""") }

# ----------------------------------------------------------------
help_form['sections'] = {
     'title'      : _(u'Rubriken für dieses Nachrichtenbrett'),
     'help'       : _(u"""<p>
Mit diesem Texteingabefeld legen Sie die möglichen Rubriken
dieses Nachrichtenbretts fest. Rubriken dienen dem Filtern von Nachrichten.
</p>
<p>
...
help_form['visible_end'] = {
     ...
     'help':_(u"""<p>
Dieses Feld legt fest, bis zu welchem Zeitpunkt dieses Nachrichtenbrett sichtbar ist.
</p>""") }
...
help_form['visible_start'] = {
     ...
     'help'       : _(u"""<p>
Dieses Feld legt den Zeitpunkt fest, ab dem dieses Nachrichtenbrett sichtbar ist.
</p>""") }
...
help_form['is_browseable'] = {
     ...
     'help'       : _(u"""<p>
Mit diesem Schalter legen Sie fest, ob dieses Nachrichtenbrett
...
help_form['has_comments'] = {
     ...
     'help'       : _(u"""<p>
Dieser Schalter legt fest, ob Nachrichten dieses Nachrichtenbretts
...
help_form['owner'] = {
     ...
     'help'       : _(u"""<p>
Tragen Sie bitte die Person oder die Institution ein, die für dieses
Nachrichtenbrett zuständig bzw. verantwortlich ist.
</p>""") }
...
help_form['tab_user_support'] = {
     ...
     'info'       : _(u"""<p>
Hier legen Sie fest, ob bzw. wer von außen Nachrichten einstellen darf.
</p>""") }

# -*- coding: utf-8 -*-
"""
/dms/newsboard/views_edit.py

.. enthaelt den View zurm Aendern der Eigenschaften des Nachrichtenbretts
...
def newsboard_edit(request, item_container):
  ...
  def save_values(item_container, old, new):
    ...
    if title.find('<') >= 0 and title.find('>') >= 0:
      item_container.item.title = title
  ...
  app_name = 'newsboard'
  my_title = _(u'Nachrichtenbrett ändern')
  data_init = {

# -*- coding: utf-8 -*-
"""
/dms/faqboard/help_form.py

.. enthaelt die kompletten Kontext-Hilfetexte fuer FAQ-Listen
...
help_form['name'] = {
     ...
     'help'       : _(u"""<p>
Tragen Sie hier den Kurznamen Ihrer FAQ-Liste ein. Dieser Kurzname wird beim Aufrufen 
der FAQ-Liste in der Web-Adresse verwendet.
</p>
...
help_form['title'] = {
     ...
     'help'       : _(u"""<p>
Tragen Sie hier die Überschrift der FAQ-Liste ein. Unter dieser Überschrift wird 
die FAQ-Liste angezeigt. Dieser Titel erscheint ebenfalls im übergeordneten
Ordner.
</p>
...
help_form['sub_title'] = {
     ...
     'help'       : _(u"""<p>
Falls erforderlich tragen Sie hier die Unterüberschrift Ihrer FAQ-Liste ein.
...
help_form['section'] = {
     ...
     'help'       : _(u"""<p>
Hier legen Sie fest, bei welchem Zwischentitel Ihre FAQ-Liste im
<b>übergeordneten</b> Ordner angezeigt wird. Bei Bedarf können 
Sie später mit der Aktion "umordnen" Ihre FAQ-Liste weiter nach oben
oder nach unten verschieben.
</p>""") }

# ----------------------------------------------------------------
help_form['sections'] = {
     'title'      : _(u'Zwischentitel für <i>diese</i> FAQ-Liste'),
     'help'       : _(u"""<p>
Mit diesem Texteingabefeld legen Sie die möglichen Zwischentitel 
für <b>diese</b> FAQ-Liste fest.
</p>
<p>
...
help_form['visible_end'] = {
     ...
     'help':_(u"""<p>
Dieses Feld legt fest, bis zu welchem Zeitpunkt diese FAQ-Liste sichtbar ist.
</p>""") }
...
help_form['visible_start'] = {
     ...
     'help'       : _(u"""<p>
Dieses Feld legt den Zeitpunkt fest, ab dem diese FAQ-Liste sichtbar ist.
</p>""") }
...
help_form['is_browseable'] = {
     ...
     'help'       : _(u"""<p>
Mit diesem Schalter legen Sie fest, ob <i>diese</i> FAQ-Liste
...
help_form['has_comments'] = {
     ...
     'help'       : _(u"""<p>
Dieser Schalter legt fest, ob FAQ-Beiträge kommentiert werden
...
help_form['tab_base'] = {
     ...
     'info'       : _(u"""<p>
Mit diesem Formular legen Sie die wichtigsten Eigenschaften der FAQ-Liste fest.
</p>""") }
...
help_form['tab_user_support'] = {
     ...
     'info'       : _(u"""<p>
Hier legen Sie fest, ob bzw. wie FAQ-Beiträge eingestellt werden dürfen.
</p>""") }

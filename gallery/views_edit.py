# -*- coding: utf-8 -*-
"""
/dms/gallery/views_edit.py

.. enthaelt den View zurm Aendern der Eigenschaften der Galerie
...
def gallery_edit(request, item_container):
  """ Eigenschaften der Galerie aendern """
  ...
  tabs = [
          ('tab_base'      , ['title', 'sub_title', 'nav_title', 'section', 'sections', 'string_2' ]),

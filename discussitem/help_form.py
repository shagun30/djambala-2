# -*- coding: utf-8 -*-
"""
/dms/discussitem/help_form.py

.. enthaelt die kompletten Kontext-Hilfetexte fuer Diskussionsbeitraege
...
help_form['moderated_text'] = {
      'title': _(u'Moderiertes Diskussionsforum'),
      'info' : _(u"""<p>
<b>Dieses Forum ist moderiert. Ihr neuer Beitrag wird erst
...
help_form['section'] = {
     ...
     'help'       : _(u"""<p>
Hier legen Sie fest, bei welchem Zwischentitel Ihr Beitrag im Forum angezeigt wird.
</p>""") }

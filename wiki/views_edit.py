# -*- coding: utf-8 -*-
"""
/dms/wiki/views_edit.py

.. enthaelt den View zum Aendern der Eigenschaften des Wikis
...
def wiki_edit(request, item_container):
  """ Eigenschaften des wikis aendern """
  ...
  data_init = {
                ...
                'role_id'         : item_container.item.integer_1,
              }
  ...
  options = ['title', 'nav_title', 'role_id' ]
  if parent_app != 'dmsWiki':
  ...
  tabs = [
          ...
          ('tab_user_support', ['has_user_support', 'has_comments', 'is_moderated']),

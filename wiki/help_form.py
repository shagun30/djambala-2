# -*- coding: utf-8 -*-
"""
/dms/wiki/help_form.py

.. enthaelt die kompletten Kontext-Hilfetexte fuer Diskussionsforen
...
help_form['name'] = {
     ...
     'help'       : _(u"""<p>
Tragen Sie hier den Kurznamen Ihres Wikis ein. Dieser Kurzname wird beim Aufrufen 
des Wikis in der Web-Adresse verwendet.
</p>
...
help_form['title'] = {
     ...
     'help'       : _(u"""<p>
Tragen Sie hier die Überschrift des Wikis ein. Unter dieser Überschrift wird 
das Wiki angezeigt. Dieser Titel erscheint ebenfalls im übergeordneten
Ordner.
</p>
...
help_form['sub_title'] = {
     ...
     'help'       : _(u"""<p>
Falls erforderlich tragen Sie hier die Unterüberschrift Ihres Wikis ein.
...
help_form['section'] = {
     ...
     'help'       : _(u"""<p>
Hier legen Sie fest, bei welchem Zwischentitel Ihr Wiki im
<b>übergeordneten</b> Ordner angezeigt wird. Bei Bedarf können 
Sie später mit der Aktion "umordnen" Ihr Wiki weiter nach oben
...
help_form['visible_end'] = {
     ...
     'help':_(u"""<p>
Dieses Feld legt fest, bis zu welchem Zeitpunkt dieses Wiki sichtbar ist.
</p>""") }
...
help_form['visible_start'] = {
     ...
     'help'       : _(u"""<p>
Dieses Feld legt den Zeitpunkt fest, ab dem dieses Wiki sichtbar ist.
</p>""") }
...
help_form['is_browseable'] = {
     ...
     'help'       : _(u"""<p>
Mit diesem Schalter legen Sie fest, ob <i>dieses</i> Wiki
...
help_form['has_comments'] = {
     ...
     'help'       : _(u"""<p>
Dieser Schalter legt fest, ob Wiki-Seiten kommentiert werden
...
# ----------------------------------------------------------------
help_form['role_id'] = {
     'title'      : _(u'Änderungsrolle'),
     'help'       : _(u"""<p>
Mit dieser Auswahlbox legen Sie die Rolle fest, die Personen mindestens besitzen
müssen, um Ergänzungen oder Änderungen an diesem Wiki vornehmen zu können. Hinweis:
Die Namen der Rollen sind in diesem Zusamenhang irreführend.
</p>""") }
...
help_form['tab_user_support'] = {
     ...
     'info'       : _(u"""<p>
Hier legen Sie fest, ob bzw. wie Wiki-Seiten eingestellt werden dürfen.
</p>""") }

# -*- coding: utf-8 -*-
"""
/dms/faqitem/views_add.py

.. enthaelt den View zum Ergaenzen eines FAQ-Beitrags
...
# -----------------------------------------------------.
def faqitem_add(request, item_container):
  """ neuen FAQ-Beitrag anlegen """
  ...
  def save_values(name, new, my_folder):
    ...
    #new['section'] = ''
    new['text_more'] = ''
    save_item_values(request.user, 'dmsFAQItem', name, new, my_folder,
  ...
  app_name = 'faqitem'
  my_title = _(u'FAQ-Beitrag anlegen')
  ...
  if request.method == 'POST' and not f.errors:
    ...
    if is_ok:
      ...
      name = 'faq_' + now[:string.find(now, '.')] + '.html'
    ...
    if my_user == None:
      #tabs = [ ('tab_base', [ 'string_1', 'string_2', 'title', 'text', 'text_more', 'section', 
      tabs = [ ('tab_base', [ 'string_1', 'string_2', 'title', 'text', 'section', 

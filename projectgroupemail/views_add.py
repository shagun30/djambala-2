# -*- coding: utf-8 -*-
"""
/dms/projectgroupemail/views_add.py

.. enthaelt den View zum Ergaenzen eines Rundschreibens
...
from dms.projectgroupemail.help_form   import help_form

from dms_ext.extension    import * # dms-Funktionen ueberschreiben

# -----------------------------------------------------
@require_permission('perm_add_folderish')
def projectgroupemail_add(request, item_container):
  """ neues Rundschreiben anlegen """
  ...
  def save_values(name, new, my_folder):
    ...
    save_container_values(request.user, 'dmsProjectgroupEmail', name, new, my_folder)
  ...
  my_title = _(u'Rundschreiben anlegen')
  # --- Sind Daten vorhanden oder muessen Sie initialisiert werden?
  show_errors = ( request.method == 'POST' )
  if show_errors:
    data = request.POST.copy()
  else :
    data = { 'name': _(u'rundschreiben'), 
             'title': _(u'Rundschreiben XXX'), 
             'sections': _(u'Aufgaben\nBesprechung\nProtokolle\nTreffen\n') }
  f = DmsItemForm(data)

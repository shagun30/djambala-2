# -*- coding: utf-8 -*-
"""
/dms/pool/help_form.py

.. enthaelt die kompletten Kontext-Hilfetexte fuer einen Materialpool
...
help_form['name'] = {
     ...
     'help'       : _(u"""<p>
Tragen Sie hier den Kurznamen Ihres Materialpools ein. Dieser Kurzname wird beim Aufrufen 
des Materialpools in der Web-Adresse verwendet. Der Kurzname sollte den Inhalt Ihres
Materialpools möglichst präzise beschreiben und gleichzeitig möglichst kurz
sein.
</p>
...
help_form['title'] = {
     ...
     'help'       : _(u"""<p>
Tragen Sie hier die Überschrift des Materialpools ein. Unter dieser Überschrift wird 
der Materialpool angezeigt. Dieser Titel erscheint ebenfalls im übergeordneten
Ordner.
</p>
...
help_form['sub_title'] = {
     ...
     'help'       : _(u"""<p>
Falls erforderlich tragen Sie hier die Unterüberschrift Ihres Materialpools ein.
...
help_form['section'] = {
     ...
     'help'       : _(u"""<p>
Hier legen Sie fest, bei welchem Zwischentitel Ihr Materialpool im
...
help_form['sections'] = {
     'title'      : _(u'Zwischentitel für <i>diesen</i> Materialpool'),
     'help'       : _(u"""<p>
Mit diesem Texteingabefeld legen Sie die möglichen Zwischentitel 
für <b>diesen</b> Materialpool fest.
</p>
<p>
...
help_form['visible_end'] = {
     ...
     'help':_(u"""<p>
Dieses Feld legt fest, bis zu welchem Zeitpunkt dieser Materialpool sichtbar ist.
</p>""") }
...
help_form['visible_start'] = {
     ...
     'help'       : _(u"""<p>
Dieses Feld legt den Zeitpunkt fest, ab dem dieser Materialpool sichtbar ist.
</p>""") }
...
help_form['is_browseable'] = {
     ...
     'help'       : _(u"""<p>
Mit diesem Schalter legen Sie fest, ob <i>dieser</i> Materialpool
...
help_form['tab_visibility'] = {
     ...
     'info'       : _(u"""<p>
Sie können die Sichtbarkeit des Materialpools auf unterschiedliche Weisen steuern.
</p>""") }

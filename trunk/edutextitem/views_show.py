# -*- coding: utf-8 -*-
"""
/dms/edutextitem/views_show.py

.. zeigt den Inhalt eines Texte innerhalb der Online-Lernarchive an
...
def get_details(item_container):
  ...
  tDetails = get_template('app/edutextitem/show_more.html')
  ...
  details = Context( {
                       ...
                       'eduobject_url': show_link(item_container.item.url_more),
                       'eduobject_description_url': eduobject_description_url,
                       'eduobject_virtual_urls': 'fehlt noch',
...
# -----------------------------------------------------
def edutextitem_show(request, item_container):

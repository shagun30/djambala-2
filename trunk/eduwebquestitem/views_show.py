# -*- coding: utf-8 -*-
"""
/dms/eduwebquestitem/views_show.py

.. zeigt den Inhalt des Webquests in einem Lernarchivs an
...
from dms.eduwebquestitem.utils  import get_user_support
from dms.eduwebquestitem.utils  import get_view_mode
...
# -----------------------------------------------------
def eduwebquestitem_show(request, item_container):
  """ 

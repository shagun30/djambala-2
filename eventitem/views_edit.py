# -*- coding: utf-8 -*-
"""
/dms/eventitem/views_edit.py

.. enthaelt den View zum Aendern der Eigenschaften eines Termins
...
def eventitem_edit(request, item_container):

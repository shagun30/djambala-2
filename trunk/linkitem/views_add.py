# -*- coding: utf-8 -*-
"""
/dms/linkitem/views_add.py

.. enthaelt den View fuer einen Verweis in einer Linkliste
...
# -----------------------------------------------------
def linkitem_add(request, item_container):
  """ neuen Verweis anlegen """
  ...
  def save_values(name, new, my_folder):
    """ Daten sichern """
    save_item_values(request.user, 'dmsLinkItem', name, new, my_folder,
  ...
  if my_user == None:
    tabs = [ ('tab_base', [ 'title', 'url_more', 'text', 'section',
                            'string_1', 'string_2', 'anti_spam_question', 'anti_spam_answer' ]),
             ( 'tab_license',    [ 'license', ] ),
           ]
  else:
    tabs = [ ('tab_base', [ 'title', 'url_more', 'text', 'section', 'string_1', 'string_2', ]),
             ( 'tab_license',    [ 'license', ] ),
           ]

# -*- coding: utf-8 -*-
"""
/dms/exercisefolder/views_edit.py

.. enthaelt den View zurm Aendern der Eigenschaften der Aufgabensammlung
...
def exercisefolder_edit(request, item_container):
  """ Eigenschaften der Aufgabensammlung aendern """
  ...
  f = dms_itemForm ( data )
  base = ['title', 'sub_title', 'nav_title', 'integer_1' ]
  if item_container.item.integer_1 == 0:
    base.append('section')
  tabs = [
            ('tab_base'        , base),

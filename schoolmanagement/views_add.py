# -*- coding: utf-8 -*-
"""
/dms/schoolmanagement/views_add.py

.. enthaelt den View zum Ergaenzen der Verwaltung von Schulseiten
...
0.01  20.05.2008  Beginn der Arbeit
"""
...
from dms.schoolmanagement.help_form   import help_form

from dms_ext.extension    import * # dms-Funktionen ueberschreiben

# -----------------------------------------------------
@require_permission('perm_manage_site')
def schoolmanagement_add(request, item_container):
  """ neue Verwaltungsseite anlegen """

  def save_values(name, new, my_folder):
    """ Daten sichern """
    save_item_values(request.user, 'dmsSchoolmanagement', name, new, my_folder, True, False)
  ...
  my_title = _(u'Verwaltung der Schulseiten anlegen')
  # --- Sind Daten vorhanden oder muessen Sie initialiSiert werden?
  show_errors = ( request.method == 'POST' )
  if show_errors:
    data = request.POST.copy()
  else :
    data = {'name': 'schoolmanagement', 'title': 'Systembetreuer, Schulleitung'}

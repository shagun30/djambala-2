...
def discussboard_manage_browseable(request, item_container):
  """ Freigabemodus des Ordners """
  return do_manage_browseable(request, item_container, u'discussboard', 
                              _(u'Beiträge freischalten/löschen'),
                              ['dmsDiscussItem'], '-name' )

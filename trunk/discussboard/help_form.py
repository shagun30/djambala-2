...
help_form['name'] = {
     ...
     'help'       : _(u"""<p>
Tragen Sie hier den Kurznamen Ihres Diskussionsforums ein. Dieser Kurzname wird beim Aufrufen 
des Diskussionsforums in der Web-Adresse verwendet.
</p>
...
help_form['title'] = {
     ...
     'help'       : _(u"""<p>
Tragen Sie hier die Überschrift des Diskussionsforums ein. Unter dieser Überschrift wird 
das Diskussionsforum angezeigt. Dieser Titel erscheint ebenfalls im übergeordneten
Ordner.
</p>
...
help_form['sub_title'] = {
     ...
     'help'       : _(u"""<p>
Falls erforderlich tragen Sie hier die Unterüberschrift Ihres Diskussionsforums ein.
...
help_form['visible_end'] = {
     ...
     'help':_(u"""<p>
Dieses Feld legt fest, bis zu welchem Zeitpunkt dieses Diskussionsforum sichtbar ist.
</p>""") }
...
help_form['visible_start'] = {
     ...
     'help'       : _(u"""<p>
Dieses Feld legt den Zeitpunkt fest, ab dem dieses Diskussionsforum sichtbar ist.
</p>""") }
...
help_form['is_browseable'] = {
     ...
     'help'       : _(u"""<p>
Mit diesem Schalter legen Sie fest, ob <i>dieses</i> Diskussionsforum
...
help_form['has_comments'] = {
     ...
     'help'       : _(u"""<p>
Dieser Schalter legt fest, ob Diskussionsbeiträge kommentiert werden
...
help_form['tab_user_support'] = {
     ...
     'info'       : _(u"""<p>
Hier legen Sie fest, ob bzw. wie Diskussionsbeiträge eingestellt werden dürfen.
</p>""") }

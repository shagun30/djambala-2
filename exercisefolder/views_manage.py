...
def exercisefolder_manage(request, item_container):
  """ Pflegemodus der Aufgabensammlung """

  user_perms = UserEditPerms(request.user.username, request.path)
  add_ons = {}
  add_ons[0] = [ { 'url' : get_site_url(item_container, 'index.html/add/exercisefolder/'),
                   'info': _(u'Aufgabensammlung')},
                 ...
                 #                      'index.html/add/edumediaitem/'),
                 #  'info': _(u'Medienpaket')},
                 #{ 'url' : get_site_url(item_container,
                 #                       'index.html/add/eduwebquestitem/'),
                 #  'info': _(u'Webquest')},
                 #{ 'url' : get_site_url(item_container,
                 #                       'index.html/add/edugalleryitem/'),
                 #  'info': _(u'Galerie')},
  ...
  app_name = u'eexercisefolder'
  my_title = _(u'Aufgabensammlung pflegen')
